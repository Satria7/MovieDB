...
//copyright satria junanda//
class PopularAdapter(private val callback: MovieCallback) :
    PagedListAdapter<MovieEntity, PopularAdapter.ListViewHolder>(DIFF_CALLBACK)  {


//    var arrayList = ArrayList<MovieEntity>()
//
//    lateinit var items: MutableList<MovieEntity>
//
//    // exampleListFull . exampleList
//    init {
//        arrayList = items as ArrayList<MovieEntity>
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder =
        ListViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_row_data2, parent, false)
        )
