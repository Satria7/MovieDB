package com.satria.jpro.lastsubmission.ui.home.content.favorite.tvshow
...
import com.satria.jpro.lastsubmission.ui.home.content.tvshow.FavoriteTVAdapter
...
class FavoriteTvShowFragment : DaggerFragment(), TvShowCallback {
    ...
    private fun setupRecyclerView() {
        rv_favorite_tvshow.apply {
            ...
            adapter = FavoriteTVAdapter(this@FavoriteTvShowFragment)
        }
    }
